...
var Zones = function (_Component) {
  ...
  _createClass(Zones, [{
    ...
    value: function componentDidMount() {
      _utils.APIManager.get('/api/place', null, function (err, response) {
        if (err) {
          alert('error ' + err);
          return;
        }
        ...
        var zones = response;
        _store2.default.currentStore().dispatch(_actions2.default.zonesReceived(zones));
      });
    }
    ...
    value: function submitZone() {
      ...
      _utils.APIManager.post('/api/place', this.state.zone, function (err, results) {
        if (err) {
          alert('error ' + err);
          return;
        }
    ...
    key: 'render',
    value: function render() {
      var listItems = this.state.list.map(function (element, i) {
        return _react2.default.createElement(
          'li',
          { key: i, style: { listStyleType: "none" } },
          _react2.default.createElement(_Zone2.default, { zone: element })
        );
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement('input', { id: 'name', type: 'text', onChange: this.updateZone.bind(this), className: 'form-control', placeholder: 'name' }),
          _react2.default.createElement('input', { id: 'zip', type: 'text', onChange: this.updateZone.bind(this), className: 'form-control', placeholder: 'zipCode' }),
          _react2.default.createElement(
            'button',
...
var Comments = function (_Component) {
  ...
  _createClass(Comments, [{
    ...
    key: 'render',
    value: function render() {
      var listItems = this.state.list.map(function (currentComment, i) {
        return _react2.default.createElement(
          'div',
          { key: i },
          _react2.default.createElement(_Comment2.default, { comment: currentComment })
        );
      });
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.submitComment.bind(this), className: 'btn' },
          'Submit Comment'
        )
      );
    }
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(50), __webpack_require__(74)(module)))
...
var _zoneReducer = __webpack_require__(85);
